...
const Login = () => {
    ...
    const performRedirect = () => {
       ...
       else if(isAuthenticated() && stepSup == 3 ){
            return <Redirect to ="/supplier/documents"/>
        }
        else if(isAuthenticated() && stepSup == 4 && SdxNumber == null){
    ...
    return (
        <>
        <Navbarr one={<AiOutlineCheck size='1.2em' color = 'black' />} two={<AiOutlineCheck size='1.2em' color = 'black' />}/>
        <div id ="container">
        <aside id = "sideBar">
          ...
          <h3 id ="loginPart">
           ...
           <br/><br/>
                  ...
                  <label id = "formLabel">Email Address</label><br/>
                  <input id="formStylee" onChange={handleChange("email")} type="email" placeholder = "email"/><br/><br/>
                  <label id = "formLabel">Password</label><br/>
                  <input id = "formStylee" onChange = {handleChange("password")}  type = "password" placeholder = "password"/><br/><br/>
                  ...
                  <Link to ='/supplier/' id ="signUp">Signup</Link>
                  <br/>
