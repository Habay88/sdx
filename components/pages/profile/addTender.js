    ...
    return (
        <>
            ...
            <div className='rulerrs' >
                ...
                <button className='tabb' onClick={onDocument}>Quality Control</button>
                ...
                <button className='tabb' onClick={onFactory}>Factory Inspection</button>
            </div>
            <div style={{ marginLeft: 60 }}>
                {step === 1 ? <Overview  /> : step === 2 ? <Production  /> : step === 3 ? <Document  /> : step === 4? <Capacity /> : step === 5 ? <Capability /> : <Factory  />}
            </div>
        </>
    )
