  ...
  const [list, setList] = useState([]);
    ...
    const onSubmit = (event) => {
       ...
       let user = {
        ...
        procurementManager : `${API}user/user/${id}/`,
        ...
        return fetch(`${API}user/procurementmanager/`, {
            method: "POST",
            headers: {
        ...
        .then(()=>{
         ...
         updateStepPm(1,id)
         if (statuss < 400){
           alert("you have successfully filled in your procurement details")
           history.push({
            pathname : "/pm/addproducts"
    
          })
         }
         else{
           alert("details is not successfully saved ")
         }
...
return(
      <>
    <NavbarrPm  one = {<AiOutlineCheck size = '1.2em' color='black'/>} two={<AiOutlineCheck size = '1.2em' color='black'/>} three={<AiOutlineCheck size = '1.2em' color = 'black'/>}/>
    <div id = "container">
    ...
    {phase === 1 ? 
         ...
         <h3 id="companyDetailsHeader">Company Details
             ...
             <br/>
                   ...
                   <input id="formStyle" readOnly={true} value={userr.RegistrationNo} type = "number"  placeholder = "Company Registration No"/><br/><br/>
                  ...
                  <select id = "formStyleSegmentIndustry" value={industryName} onChange={(e)=>{
                   ...
                   <input onChange={(e)=>{
                         ...
                         }} id = "formStylee" type = "text" placeholder = "Company Website"/><br/>
                    ...
                    <span style={{marginLeft: '16%', position: 'absolute', fontSize: 17}}>Hi, {name }
                           <button  className='backed' onClick={onSignout} > Logout</button></span>
                              ...
                              <input value={contactEmail} onChange={(e)=>{
                                    ...
                                    }}  id = "formStylee" type = "text" placeholder = "Email"/><br/><br/>
