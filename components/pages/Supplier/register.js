...
const Register = () => {
     ...
     const [values, setValues] = useState({
      ...
      const {name, email, password, RegistrationNo , phone ,TinNumber,NaicomNumber, error,is_supplier=true, success, companyName  } = values;
      ...
      const onSubmit = (e) => {
        ...
        signup({companyName, email, password, TinNumber,NaicomNumber,is_supplier,RegistrationNo,phone })
        .then((data) =>{
