  ...
  const name = window.localStorage.getItem('name')
    ...
    const onSubmit = (event) => {
       ...
       let user = {
        ...
        TinNumber : userr.TinNumber,
        NaicomNumber : userr.NaicomNumber
        ...
        {phase === 1 ? 
         ...
         <h3 id="companyDetailsHeader">Company Details
             ...
             <br/>
                   ...
                   <label id="formLabel">Company Tin Number</label><br />
                    <input id="formStyle" readOnly={true} value={userr.TinNumber} type="text" placeholder="Company Tin Number" /><br /><br />
                    <label id="formLabel">Company Naicom Number</label><br />
                    <input id="formStyle" readOnly={true} value={userr.NaicomNumber} type="text" placeholder="Company Naicom Number" /><br /><br />
